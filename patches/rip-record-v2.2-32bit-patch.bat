...
setx PATH "C:\Program Files (x86)\Rip-Record\Git\usr\bin;C:\Program Files (x86)\Rip-Record\Git\cmd;C:\Program Files (x86)\Rip-Record\Git\bin;%UserProfile%\git\kodi-playercorefactory\bash-scripts-windows"
